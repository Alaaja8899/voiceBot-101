...
options.forEach(option =>{
    option.onclick = ()=>{
        if (option.textContent.includes('who is Levi ?')){
            ...
            document.querySelector('.message-body').innerHTML+= `<div class="bot-msg"><span class="bot-img"><img src="assets/support.png" alt="bot profile image"></span><p>
            ...
            document.querySelector('.message-body').innerHTML+= `<div class="bot-msg"><span class="bot-img"><img src="assets/support.png" alt="bot profile image"></span><p>    <img src="assets/zack.jpg" alt="zack founder" class="m-img"></p></div>`
            $('.message-body').scrollTop($('.message-body')[0].scrollHeight);
